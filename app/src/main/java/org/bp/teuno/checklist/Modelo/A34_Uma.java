...
public class A34_Uma {

    public String ID;
    public String ID_UMA;
    ...
    public A34_Uma(String ID, String ID_UMA, String MEDICION, String TEMPERATURA, String HUMEDAD, String ALERTA, String HORA_INGRESO, String HORA_SALIDA, String ID_TURNO, String RONDA, String ESTADO, String USUARIO_INGRESA, String USUARIO_MODIFICA, String FECHA_INGRESO, String FECHA_MODIFICACION) {
        this.ID = ID;
        this.ID_UMA = ID_UMA;
    ...
    public String getID_UMA() {
        return ID_UMA;
    }

    public void setID_UMA(String ID_UMA) {
        this.ID_UMA = ID_UMA;
    }
